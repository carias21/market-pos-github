     ...
     $(document).ready(function() {
        ...
        function numberWithCommas(x) { return x.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","); }
         ...
         success: function(respuesta) {
           ...
           $("#totalCompras").html('Q.' + respuesta[0]['totalCompras'].toLocaleString('DE-de'))
           //otras opciones de mostrar las cantidades: .toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}))
           $("#totalVentas").html('Q.' + respuesta[0]['totalVentas'].toLocaleString('de-DE'))
           $("#totalGanancias").html('Q.' + respuesta[0]['ganancias'].toLocaleString('de-DE'))
           $("#totalProductosMinStock").html(respuesta[0]['productosPocoStock'].toLocaleString('de-DE'))
           $("#totalVentasHoy").html('Q.' + respuesta[0]['ventasHoy'].toLocaleString('de-DE'))
         }
       });
       ...
       setInterval(() => {
         $.ajax({
           ...
           success: function(respuesta) {
             ...
             $("#totalCompras").html('Q.' + respuesta[0]['totalCompras'].toLocaleString('de-DE'))
             $("#totalVentas").html('Q.' + respuesta[0]['totalVentas'].toLocaleString('de-DE'))
             $("#totalGancias").html('Q.' + respuesta[0]['ganancias'].toLocaleString('de-DE'))
         ...
         $.ajax({
             ...
             success: function(respuesta) {
                 ...
                 $("#title-header").html('Ventas del Mes: Q. ' + total_ventas_mes.toString().replace(
                     /\d(?=(\d{3})+\.)/g, "$&,"));
